...
def run_demo(net, image_provider, height_size, cpu):
    ...
    for img in image_provider:
        ...
        leftx,lefty = all_keypoints[11, 0:2]
        rightx,righty = all_keypoints[8, 0:2]
        print(neckx," neck ",necky)
        print(rightx," right ",righty)
        print(leftx," left ",lefty)
        # print(p1x," == ",(p2x+p5x)/2)
        ...
        b = np.array([[float(rootx)],[float(rooty)],[1]])
        print(A)
        print(b)
        lamda = solve(A,b)
        print(lamda)
